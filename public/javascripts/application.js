$(function() {
    ...
    function addNewResultRow(){
       ...
       var index = result_table.find("tr.result_set_row").length + 1
       var item=
           '<tr class="result_set_row">'+
              '<td><input class="result_set_team_score_input" type="text" name="result['+index+'[team1]]"></input></td>'+
              '<td><input class="result_set_team_score_input" type="text" name="result['+index+'[team2]]"></input></td>'+
